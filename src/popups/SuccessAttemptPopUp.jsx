        ...
        <div className="succesfull-attempt-content">
          {selectedLanguage === 0 ? (
            <p>
              ...
              It is known as a <span className="yellow-text">Field Goal</span> . These Field Goals will
              be counted towards{" "}
            ...
            <p>
              <span className="yellow-text">Successful attempts</span> vo attempts hai jisme Basketball successfully
              basket me enter karta hain. Use <span className="yellow-text">
              Field Goal
                </span>  kehte hain. Inn Field
              Goals ko <span className="yellow-text">Field Goal Milestones </span>mein count kiya jayega. Iska
              progress bar niche dikhaya gaya hai.
            </p>
          )}
        </div>
      </div>
